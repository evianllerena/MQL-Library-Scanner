...
async function finishScan(){state.scanning=false;scanBtn.disabled=false;addFolderBtn.disabled=false;state.page=0;state.reviewPage=0;await reloadAll();}
